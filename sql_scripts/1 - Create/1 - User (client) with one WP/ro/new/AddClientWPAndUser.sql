...
-- Company
DECLARE @U_CompanyName nvarchar(50) = 'test'; -- details in less used section

-- Subscription
DECLARE @C_Subscription_Type nvarchar(50) = 'Free'; -- details in less used section

-- Support working point
DECLARE @WP_Support_TelNumber nvarchar(50) = '4440000100';
...
DECLARE @WP_Support_XmppSuffix nvarchar(50) = '@devxmpp.txtfeedback.net';
...
DECLARE @SD_BillingDay int = 1;
DECLARE @SD_SubscriptionSMS int = 200;
DECLARE @SD_RemainingSMS int = 200;
DECLARE @SD_SpendingLimit int = 100;
DECLARE @SD_WarningLimit int = 50;
DECLARE @SD_RemainingAccount int = 150;
DECLARE @SD_CurrencySymbol nvarchar(50) = 'EUR';
...
BEGIN
INSERT INTO SubscriptionDetails (BillingDay, SubscriptionSMS, RemainingSMS, SpendingLimit, WarningLimit, RemainingAmount, CurrencySymbol)
