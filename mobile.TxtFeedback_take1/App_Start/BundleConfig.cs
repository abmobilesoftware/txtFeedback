...
namespace mobile.TxtFeedback_take1
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/survey.js").Include(
            ...
            bundles.Add(new StyleBundle("~/bundles/skeleton.css").Include(
                    "~/Content/skeleton/base.css",
                    "~/Content/skeleton/layout.css",
                    "~/Content/skeleton/skeleton.css"
                ));

            bundles.Add(new StyleBundle("~/bundles/survey.css").Include(
                    "~/Content/reset.css",
                    "~/Content/survey.css"
                ));
