function newMessageReceived(convView, msgView, fromID, convID, msgID, dateReceived, text, trimmedText) {
    convView.newMessageReceived(fromID, convID, dateReceived, trimmedText);
