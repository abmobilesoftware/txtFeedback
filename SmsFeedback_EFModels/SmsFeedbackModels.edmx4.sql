...
-- --------------------------------------------------
-- Date Created: 08/22/2012 15:28:02
...
GO
IF OBJECT_ID(N'[dbo].[FK_AnotherWorkingPointConversation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Conversations] DROP CONSTRAINT [FK_AnotherWorkingPointConversation];
GO
...
IF OBJECT_ID(N'[dbo].[FK_WorkingPointConversation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[WorkingPoints] DROP CONSTRAINT [FK_WorkingPointConversation];
GO
