...
-- --------------------------------------------------
-- Date Created: 08/29/2012 16:21:51
...
-- Creating table 'ConversationTags1'
CREATE TABLE [dbo].[ConversationTags1] (
...
-- Creating primary key on [ConversationConvId], [TagName], [TagCompanyName] in table 'ConversationTags1'
ALTER TABLE [dbo].[ConversationTags1]
ADD CONSTRAINT [PK_ConversationTags1]
...
-- Creating foreign key on [ConversationConvId] in table 'ConversationTags1'
ALTER TABLE [dbo].[ConversationTags1]
...
-- Creating foreign key on [TagName], [TagCompanyName] in table 'ConversationTags1'
ALTER TABLE [dbo].[ConversationTags1]
