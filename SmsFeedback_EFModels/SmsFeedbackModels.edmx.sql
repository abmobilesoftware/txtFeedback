...
-- --------------------------------------------------
-- Date Created: 06/24/2013 15:06:03
...
GO
IF OBJECT_ID(N'[dbo].[InvoiceDetailsTemplate]', 'U') IS NOT NULL
    DROP TABLE [dbo].[InvoiceDetailsTemplate];
GO
IF OBJECT_ID(N'[dbo].[Invoices]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Invoices];
GO
IF OBJECT_ID(N'[smsfeedbackModelStoreContainer].[Log]', 'U') IS NOT NULL
    DROP TABLE [smsfeedbackModelStoreContainer].[Log];
GO
